...
divcad2 = list()
print('--------------------------------')
print('|  Token |', f"{'':>2}", 'Type', f"{'':>5}", '|  ID |', f"{'':<4}")
print('--------------------------------')
for objlex in listalexico:
    print ("{:<8} {:<15} {:<15} ".format("   "+objlex.cad,"|"+objlex.tipo,"|  "+str(objlex.pos)))
...
if len(listaerrores)!=0:
    ...
    print('| Tipo', f"{'':>1}", '|  ID', f"{'':>1}", '| Ambito   |')
    print('-----------------------------------')
    for obj in listavariables:
        print ("{:<8} {:<7} {:<10} ".format("   "+obj.data.cad,"| "+obj.tipo.cad,"|  "+obj.lv))
